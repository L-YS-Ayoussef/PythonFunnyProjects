# PythonFunnyProjects 🎉  
A Collection of Fun Python Mini-Apps

## 🌍 Overview  
**PythonFunnyProjects** is a collection of small, playful Python projects built mainly for learning, experimentation, and fun.  
Each project lives in its own folder with its own `README.md`, code, and assets.

This repo is a great place to explore beginner–intermediate Python concepts through quirky little apps.
...
### 1️⃣ Crossing Game 🐢  
**Folder:** `Crossing-Game-Turtle-Dodge/`  
**Crossing Game** is a simple arcade-style game built with Python’s `turtle` module.  
You control a small turtle trying to cross the screen while colorful “cars” move horizontally. Each successful crossing increases your score and level, and with every level the game becomes faster and more challenging. If the turtle collides with a car, it’s **Game Over** and you can try again.

### 2️⃣ FlashyWords 🇫🇷📚
**Folder:** `FlashyWords-French-Flashcard-Trainer/` 
...
### 3️⃣ LockIt 🔐
**Folder:** `LockIt-Simple-Password-Data-Manager/`  
...
- 
### 4️⃣ Pomodoro ⏱️ – Focus Timer  
**Folder:** `PomodoroTimer/`  
A colorful desktop Pomodoro timer built with Tkinter and Pygame.  
Features work/break cycles, start–pause–resume controls, an alarm sound, and visual checkmarks with total time worked.
...
### 6️⃣ Quizzer True/False ✅❌
**Folder:** `Quizzer-True-False-Quiz-App/`  
...
### 7️⃣ Simple Calculator App 📟
**Folder:** `Simple-Flask-Calculator/`  
